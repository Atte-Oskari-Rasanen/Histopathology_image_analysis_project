...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug  6 15:04:06 2021
...
def get_model():
    return simple_unet_model(256, 256, 1) #enter model name with the dimensions of the image along with channel number



def prediction(model, image, patch_size): # crop the large image into smaller patches

...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug  1 14:54:19 2021
...
model = load_model("home/atte/Documents/Scripts_image_analysis/model-dsbowl2018-2.h5")

model = keras.models.load_model("/home/atte/Documents/Scripts_image_analysis/model-dsbowl2018-2.h5")
...
base_inputs = model.layers[0].input #use this as the base model
base_output = model.layers[-2].output #this way we dont want the output from the last layer but the second last

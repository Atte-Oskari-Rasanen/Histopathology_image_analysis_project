...
cp_save_path = "/cephyr/NOBACKUP/groups/snic2021-23-496/scripts/kaggle_own_model_size512.h5"
...
plt.savefig('plot1_kaggle_own_data_s512.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('plot2_kaggle_own_data_s512.png')

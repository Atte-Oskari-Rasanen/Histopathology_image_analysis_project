...
import os
# load the image
path = '/home/atte/Pictures/Deconv_im/'
#os.listdir(path)
img = load_img('/home/atte/Pictures/Deconv_im/20xgraft.png')
...
for i in range(9):
    ...
    pyplot.savefig('/home/atte/Pictures/Deconv_im/'+str(i)+'_Training20xgraft.tif.', bbox_inches='tight')
